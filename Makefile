...
# Source files
KERNEL_SRCS = kernel/minimal.c kernel/shell_new.c kernel/idt.c kernel/string.c fs/filesystem.c kernel/process.c drivers/timer.c drivers/keyboard.c kernel/context.c kernel/test_process.c kernel/syscall.c kernel/user_process.c kernel/memory.c kernel/memory_test.c kernel/usermode.c kernel/user_program.c
