...
KERNEL_SRCS := $(shell find kernel/ -name '*.c' -not -name 'test_*.c' -not -name '*_test.c' -not -name 'tests.c' -not -name 'string_tests.c' -not -name 'process.c' -not -name 'monitor.c' -not -name 'power.c' -not -name 'interrupt_test.c' -not -name 'minimal.c' -not -name 'syscall.c' -not -name 'usermode.c') kernel/kmain.c kernel/process_simple.c
