...
# Source files
KERNEL_SRCS = kernel/minimal.c kernel/shell_new.c kernel/idt.c kernel/string.c fs/filesystem_enhanced.c kernel/process.c drivers/timer.c drivers/keyboard.c kernel/context.c kernel/test_process.c kernel/syscall.c kernel/user_process.c kernel/memory.c kernel/memory_test.c kernel/usermode.c kernel/user_program.c kernel/fs_test.c kernel/network.c kernel/network_test.c kernel/vm.c kernel/vm_test.c kernel/device.c kernel/device_test.c drivers/block_device.c drivers/char_device.c kernel/security.c kernel/security_test.c
