...
gcc $CFLAGS $INCLUDES -c kernel/idt.c -o kernel/idt.o 2>&1 && echo "idt.o OK" || echo "idt.o failed"
...
gcc $CFLAGS $INCLUDES -c kernel/program_loader.c -o kernel/program_loader.o 2>&1 && echo "program_loader.o OK" || echo "program_loader.o failed"
...
gcc $CFLAGS $INCLUDES -c drivers/vga.c -o drivers/vga.o 2>&1 && echo "vga.o OK" || echo "vga.o failed"
gcc $CFLAGS $INCLUDES -c drivers/keyboard.c -o drivers/keyboard.o 2>&1 && echo "keyboard.o OK" || echo "keyboard.o failed"
gcc $CFLAGS $INCLUDES -c drivers/keyboard_intl.c -o drivers/keyboard_intl.o 2>&1 && echo "keyboard_intl.o OK" || echo "keyboard_intl.o failed"
gcc $CFLAGS $INCLUDES -c drivers/serial.c -o drivers/serial.o 2>&1 && echo "serial.o OK" || echo "serial.o failed"
gcc $CFLAGS $INCLUDES -c drivers/timer.c -o drivers/timer.o 2>&1 && echo "timer.o OK" || echo "timer.o failed"
